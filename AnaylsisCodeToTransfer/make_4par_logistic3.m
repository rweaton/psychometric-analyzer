function [beh_p,beheff,xrange,beh_curve]=make_4par_logistic2(allstim,allbeh,rowser,prestimes)
	...
	[parsx]=logistfit_parm4(data); %%4 parm fit
	%behpar=pars';
	behpar4=parsx';
	...
	%%getcurves	
	%xrange=[-5:.1:5];
    xrange=min(prestimes):max(prestimes);
