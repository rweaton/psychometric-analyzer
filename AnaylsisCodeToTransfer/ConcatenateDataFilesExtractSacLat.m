function FourParamStruct = ConcatenateDataFilesExtractBehResp(path, filenames, SOAsToInclude, ConditionsToInclude, LastTrialList)
    ...
    for k = 1:nFiles
        ...
        [ss1, tt1, uu1] = CreateCortexObjExtractBehResp(path, filenames{k}, unfoldgrp, unfoldedsoas);
...
%    FourParamStruct.PseudoRSquaredVal = PseudoRSquaredVal;
    ...
    FourParamStruct.BehavioralResponseTimes = uu1;
