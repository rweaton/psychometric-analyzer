...
filenames = {'GBSOAM11.1','GBSOAM11.2','GBSOAM11.3'};
SOAsToInclude = [0 20 40 80 160 320];
LastTrialList = [2713 220 1072];
nIterations = 2000;
nBins = 10;
...
%%%%%%%%%%%%  Conditions 1 to 84 Run Block %%%%%%%%%%%%%%%%%%%

ConditionsToInclude = 1:84;

FourParamStruct1to84 = ConcatenateDataFiles4Param(path, filenames, ...
      SOAsToInclude, ConditionsToInclude, LastTrialList);

UnsortedEstimatedParamVals1to84 = EstimatedFourParameterMonteCarlo(...
           FourParamStruct1to84.DataPoints(2,:), ... 
           FourParamStruct1to84.DataPoints(1,:), ...
           FourParamStruct1to84.NumTrialsPerSOA, nIterations, nBins);

OutputStruct = RemoveOutlierEntries( ...
    UnsortedEstimatedParamVals1to84, 1);

UnsortedEstimatedParamVals1to84 = OutputStruct.FilteredList;
        
EstimatedParamMCOutputArray1to84 = ComputeConfidenceLimits(...
    UnsortedEstimatedParamVals1to84, nBins);

EstimatedParams1to84 = [EstimatedParamMCOutputArray1to84(1).SampleAverage, ...
     EstimatedParamMCOutputArray1to84(2).SampleAverage, ...
     EstimatedParamMCOutputArray1to84(3).SampleAverage, ...
     EstimatedParamMCOutputArray1to84(4).SampleAverage];

SatModDeviance1to84 = ComputeDeviance4( ...
    FourParamStruct1to84.DataPoints(1,:), ...
    FourParamStruct1to84.DataPoints(2,:), ...
    FourParamStruct1to84.NumTrialsPerSOA, ...
    EstimatedParams1to84);
 
DevianceDistributionStruct1to84 = FourParamDevianceMonteCarlo( ...
    FourParamStruct1to84.DataPoints(1,:), ...
    FourParamStruct1to84.NumTrialsPerSOA, ...
    EstimatedParams1to84, nIterations, nBins);

StimParamList{6}.Params = EstimatedParams1to84;

StimParamList{6}.StdErr = [EstimatedParamMCOutputArray1to84(1).StdErrRange/2, ...
     EstimatedParamMCOutputArray1to84(2).StdErrRange/2, ...
     EstimatedParamMCOutputArray1to84(3).StdErrRange/2, ...
     EstimatedParamMCOutputArray1to84(4).StdErrRange/2]; 
